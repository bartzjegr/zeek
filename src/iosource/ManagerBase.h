...
/**
 * Base class for the IOSource Manager. Since the Manager class itself can be
 * specialized based on the poll architecture provided by the OS, this class
 * provides a number of common methods and variables that are used by all of
 * the specializations.
 */
class ManagerBase {
public:
	 ...
	 */
	virtual void RegisterFd(int fd, IOSource* src) {}
